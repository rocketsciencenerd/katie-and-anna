          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 p-7 border border-sage/40 bg-sage/10">
              ...
              <p className="text-bark/65 text-sm font-light leading-relaxed">
                Unless named on your invitation, we are unable to extend our invite to children outside of immediate family and godchildren. Thank you for understanding!
              </p>
            </div>
          </div>
        </section>
