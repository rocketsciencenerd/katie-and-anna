          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 p-7 border border-sage/40 bg-sage/10">
              ...
              <p className="text-bark/65 text-sm font-light leading-relaxed">
                Kids are welcome to join us if they are on the invite list. We kindly ask parents to supervise. Como Park Conservatory has ample outdoor space — anyone who needs a moment away from the ceremony or speeches is free to roam the grounds.
              </p>
            </div>
          </div>
        </section>
